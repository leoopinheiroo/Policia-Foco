...
export const Dossier: React.FC<DossierProps> = ({ userHistory, onReviewQuestion }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 animate-fade-in pb-20">
      {/* Header */}
      <header className="bg-slate-900 rounded-[3rem] p-12 md:p-16 text-white mb-12 shadow-2xl relative overflow-hidden border border-slate-800">
        <div className="relative z-10">
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4 flex items-center gap-4">
            <Folder className="text-yellow-500 w-12 h-12 md:w-16 md:h-16" /> Dossiê de Evidências
          </h2>
